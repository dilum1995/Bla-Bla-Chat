 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://ServicesGenerator/", wsdlLocation = "http://localhost:8080/ConnectServer/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://ServicesGenerator/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ConnectServer/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://ServicesGenerator/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServicesGenerator/", "UserServicePort"), UserService.class, features);
    }
